 ...
 * 
 */
package ms.piston.Presentacion.Cliente.VModificarCliente.imp;
...
public class ActionListenerImp implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		// begin-user-code
		VModificarCliente v = (VModificarCliente) VModificarCliente.getFrame();
		TCliente cliente;
		int telefono;
		...
		try{
			...
			else if(empresa != "")
			{
				...
				Controlador.ObtenerInstancia().accion(7 , cliente);
				v.dispose();
