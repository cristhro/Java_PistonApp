 ...
 * 
 */
package ms.piston.Presentacion.Cliente.VConsultarCliente;
 ...
 */
public class VConsultarCliente extends JFrame implements command {
	private static JFrame ventana;
	public VConsultarCliente() throws HeadlessException {
	...
	public Object ejecuta(Integer Orden, Object Datos) {
		...
		initGUI();
		Controlador.ObtenerInstancia().accion(9,Datos); //leer cliente por nif
